			...
			<form action="" method="">
				...
				<div class="form-group">
					...
					if(isset($_GET['edit'])){
						...
						$cat_id_value = $_GET['edit'];

						$ft = $conn->query("SELECT * FROM catagory WHERE cat_id ={$cat_id_value}");
					...
					<input type="text" value="<?php if(isset($the_cat_title)){echo $the_cat_title; } ?>" name="cat_title" class="form-control" placeholder="Catagory name...">
				...
				<tbody>
					...
					<?php
						...
						if(isset($_GET['delete'])){
							...
							echo $cat_id =$_GET['delete']; 

							$ft = $conn->query("DELETE FROM catagory WHERE cat_id={$cat_id}");
					...
					<?php
						...
						if(isset($_GET['edit'])){
							...
							echo $the_cat_id =$_GET['edit']; 

							$ft = $conn->query("UPDATE FROM catagory WHERE cat_id={$the_cat_id}");
